...
Build system targets that are only useful for developers of this project are hidden if the `primordial-fluctuation-simulator_DEVELOPER_MODE` option is disabled.
...
You have a few options to pass `primordial-fluctuation-simulator_DEVELOPER_MODE` to the configure command, but this project prefers to use presets.
